...
module.exports = {
  mongodb: {
    ...
    port:  3001, 
    //process.env.ME_CONFIG_MONGODB_PORT || mongo.port,
    ...
    admin: true,
    //process.env.ME_CONFIG_MONGODB_ENABLE_ADMIN ? process.env.ME_CONFIG_MONGODB_ENABLE_ADMIN.toLowerCase() === 'true' : false,
